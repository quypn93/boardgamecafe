        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Arcade>(entity =>
            {
                ...
                entity.HasOne(e => e.CreatedBy)
                    .WithMany(u => u.CreatedArcades)
                    .HasForeignKey(e => e.CreatedByUserId)
                    .OnDelete(DeleteBehavior.SetNull);

                entity.HasOne(e => e.PremiumListing)
                    .WithOne(p => p.Arcade)
                    .HasForeignKey<PremiumListing>(p => p.ArcadeId)
                    .OnDelete(DeleteBehavior.Cascade);
            });

            // VRGame Configuration
            modelBuilder.Entity<VRGame>(entity =>
            {
                entity.HasKey(e => e.GameId);

                entity.HasIndex(e => e.SteamAppId);
                entity.HasIndex(e => e.OculusAppId);
                entity.HasIndex(e => e.Name);
                entity.HasIndex(e => e.VRPlatform);
            ...
            // ArcadeGame Configuration (Many-to-Many)
            modelBuilder.Entity<ArcadeGame>(entity =>
            {
                entity.HasKey(e => e.ArcadeGameId);

                entity.HasIndex(e => new { e.ArcadeId, e.GameId }).IsUnique();

                entity.HasOne(e => e.Arcade)
                    .WithMany(c => c.ArcadeGames)
                    .HasForeignKey(e => e.ArcadeId)
                    .OnDelete(DeleteBehavior.Cascade);

                entity.HasOne(e => e.Game)
                    .WithMany(g => g.ArcadeGames)
            ...
            modelBuilder.Entity<PremiumListing>(entity =>
            {
                ...
                entity.HasIndex(e => e.ArcadeId).IsUnique();
                entity.HasIndex(e => e.IsActive);
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.Property(e => e.IsArcadeOwner).HasDefaultValue(false);
                entity.Property(e => e.CreatedAt).HasDefaultValueSql("GETUTCDATE()");
            });
            ...
            modelBuilder.Entity<City>(entity =>
            {
                ...
                entity.HasIndex(e => e.CrawlCount);
                entity.HasIndex(e => e.LastCrawledAt);
            ...
            modelBuilder.Entity<CrawlHistory>(entity =>
            {
                ...
                entity.Property(e => e.ArcadesFound).HasDefaultValue(0);
                entity.Property(e => e.ArcadesAdded).HasDefaultValue(0);
                entity.Property(e => e.ArcadesUpdated).HasDefaultValue(0);
